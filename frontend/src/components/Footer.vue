<template>
  <div
    class="
      ...
      bottom-0
      text-gray-600
      border-t-3 border-gray-600
    "
  >
    <div
      class="grid lg:grid-cols-3 gap-y-8 gap-x-20 w-full my-auto p-10 lg:pr-56"
    >
      <div class="w-auto h-auto text-left lg:text-left">
        <p class="font-thin text-white text-2xl">Learn More</p>
        <hr class="w-auto my-3" />
        <div class="flex flex-col gap-3 text-white">
          <a href="/"
            ><div class="text-left lg:text-left hover:underline pt-2">
              <p class="font-thin text-l">Home</p>
            </div></a
          >
          <a href="/projects"
            ><div class="text-left lg:text-left hover:underline">
              <p class="font-thin text-l">Projects</p>
            </div></a
          >
          <a href="/news"
            ><div class="text-left lg:text-left hover:underline">
              <p class="font-thin text-l">News</p>
            </div></a
          >
          <a href="/join"
            ><div class="text-left lg:text-left hover:underline">
              <p class="font-thin text-l">Join Us</p>
            </div></a
          >
          <a href="/about"
            ><div class="text-left lg:text-left hover:underline">
              <p class="font-thin text-l">About Us</p>
            </div></a
          >
          <a href="/donate">
            <div class="text-left lg:text-left hover:underline">
              <p class="font-thin text-l">Donate Now</p>
            </div></a
          >
        </div>
      </div>
      ...
      <div class="w-auto h-auto text-left">
        <p class="font-thin text-white text-2xl">Get in Touch</p>
        <hr class="w-auto my-3" />

        <div class="flex flex-col gap-3 text-black">
          <a href="#" @click="emailFunction(footer.email)"
            ><div
              class="flex flex-row gap-x-2 items-center pt-2 text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
          ...
          <a :href="footer.mapsLink" target="_blank"
            ><div class="flex flex-row gap-x-2 items-center text-white">
              ...
              <p class="font-thin text-l">Archio Jakarta</p>
            </div></a
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    async refreshPage() {
      this.headerAuth = await api.login().then((result) => {
        return "Bearer " + result.jwt;
      });

      this.footer = await api.getFooter(this.headerAuth).then((result) => {
        return result.data;
      });
